...
import com.example.mynotes_berdnikova.DataBase.DB;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickAdd(View view) {
        ...
        Toast.makeText(this, "Заметка добавлена в базу данных", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onClickDelete(View view) {
        ...
        if(db.containRecById(ID)){
            ...
            Toast.makeText(this, "Заметка удалена из базы данных", Toast.LENGTH_SHORT).show();
        }else {
            editTextNodeId.setText("");
            Toast.makeText(this, "Заметки нет в базе данных", Toast.LENGTH_SHORT).show();
        }
    }
